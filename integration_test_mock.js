...
async function runTest() {
  ...
  mockDb.push(insertData);
  console.log("Evento insertado ID:", mockEventId);
  ...
  const record = mockDb.find(r => r.id === mockEventId);
  ...
  const eventData = mockDb.find(r => r.id === mockEventId);
