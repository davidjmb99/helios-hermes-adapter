...
COPY server.js contract-parser.js processing-diagnostics.js tenant-context.js hermes-agent-client.js request-identity.js execution-store.js supabase-assert.js pricing.js ./
